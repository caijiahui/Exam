...
namespace advt.Common
{
	...
	public class wbRequest
	{
        ...
        /// <param name="strName">参数</param>
        /// <returns>Url或表单参数的值</returns>
        public static string GetStringCleanInput(string strName)
        {
            return Utils.CleanInput(GetString(strName, false));
        }
        ...
        {
            if ("".Equals(GetQueryString(strName)))
                return GetFormGuid(strName);
            else
                return GetQueryGuid(strName);
        }
        ...
        /// <returns></returns>
        private static Guid GetQueryGuid(string strName)
        {
            return TypeConverter.ObjectToGuid(GetQueryString(strName));
        }
        ...
        /// <param name="strName"></param>
        /// <returns></returns>
        private static Guid GetFormGuid(string strName)
        {
            return TypeConverter.ObjectToGuid(GetFormString(strName));
        }
