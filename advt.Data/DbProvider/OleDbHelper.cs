...
namespace advt.Data
{
    ...
    /// 数据访问助手类
    /// </summary>
    public partial class OleDbHelper
    {

        public DataTable getDT(string CommandText)
        {
            using (OleDbConnection conn = new OleDbConnection())
            {
                ...
                OleDbDataAdapter dp = new OleDbDataAdapter(CommandText, conn);
                ...
                if (m_provider == null)
                {
                    lock (lockHelper)
                    {
                        if (m_provider == null)
                        {
                            ...
                            {
                                throw new Exception("请检查.config中Dbtype节点数据库类型是否正确??");
                            }
                        }
                    }
                }
        ...
        /// (注:主数据库链接即为Ri.config文件中Dbconnectstring的链接地址)
        /// </summary>
        /// <remarks>
        /// 示例:  
        ...
        /// <summary>
        /// 在主数据库中执行指定数据库连接对象的数据阅读器.(注:主数据库链接即为Ri.config文件中Dbconnectstring的链接地址)
        /// </summary>
        /// <remarks>
        /// 如果是BaseDbHelper打开连接,当连接关闭DataReader也将关闭.
        /// 如果是调用都打开连接,DataReader由调用都管理.
        ...
        /// <summary>
        /// Reader数据转换为ObjClass类型
        /// </summary>
        /// <typeparam name="T"><peparam>
        /// <param name="reader"></param>
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<T> setReaderToObject<T>(IDataReader reader) where T : new()
        {
        ...
        /// <summary>
        /// Reader一行数据转换为ObjClass类型
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="targetObj"></param>
        public void setOneReaderToObject(IDataReader reader, object targetObj)
        {
        ...
        /// <summary>
        /// 将DataTable数据转换为List Object
        /// </summary>
        /// <param name="dt">DataTable</param>
        public List<T> setDataTableToObject<T>(DataTable dt) where T : new()
        {
            List<T> ls = new List<T>();
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public IEnumerable<T> GetReaderToIEnumerable<T>(IDataReader reader) where T : new()
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TReturn>(IDataReader reader, Func<TFirst, TSecond, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, T12, T13, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, T12, T13, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public List<TReturn> GetReaderToList<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn>(IDataReader reader, Func<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn> map, string splitOn = "Id")
        {
        ...
        /// <param name="targetObj"></param>
        /// <returns></returns>
        public IEnumerable<TReturn> GetReaderToIEnumerable<TFirst, TSecond, TThird, TFourth, TFifth, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn>(IDataReader reader, object map, string splitOn)
        {
        ...
        public List<T> GetReaderToList<T>(IDataReader reader) where T : new()
        {
